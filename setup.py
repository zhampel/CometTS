...
NAME = 'cometts'
DESCRIPTION = 'A toolkit for visualizing geospatial time-series data',
MAINTAINER = 'cosmiq, lab41'
...
about = {}
with io.open(os.path.join(here, 'cometts', '__version__.py'), encoding='utf-8') as f:
    exec(f.read(), about)
